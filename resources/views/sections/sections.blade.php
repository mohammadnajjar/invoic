...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الاعدادات</h4><span class="text-muted mt-1 tx-13 mr-2
							mb-0">/ الاقسام</span>
            </div>
        </div>
    </div>
...
@section('content')
                                            ...
                                            <form action="{{route('sections.destroy',$section->id)}}" method="post">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <input class="form-control" name="section_name" id="section_name"
                                                           type="text" readonly value="{{$section->section_name}}">
                                                </div>
                                                <div class="modal-footer">
    ...
    <div class="modal" id="modaldemo8">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">اضافة فسم</h6>
                ...
                <div class="modal-body">
                    <form class="form-horizontal" action="{{route('sections.store')}}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="section_name" placeholder="اسم القسم"
                                   name="section_name">
                        </div>
                        <div class="form-group">
