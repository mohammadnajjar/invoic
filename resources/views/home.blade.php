        ...
        <div class="left-content">
            <div>
                <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">
                    مرحباً ، {{auth()->user()->name}} أهلا بكم من جديد.
                </h2>
    ...
    <div class="row row-sm">
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-danger-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    <div class="">
                        <h6 class="mb-3 tx-16 text-white">الفواتير غير المدفوعة</h6>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                        ...
                        <div class="d-flex">
                            ...
                            <span class="float-right my-auto mr-auto">
											...
											<span class="text-white op-7">
                                                @php
                                                    $count_all= \App\Models\Invoice::count();
                                                    $count_invoices1 = \App\Models\Invoice::where('value_status', 2)
                                                    ->count();
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-warning-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    <div class="">
                        <h6 class="mb-3 tx-16 text-white">الفواتير المدفوعة جزئيا</h6>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                            ...
                            <span class="float-right my-auto mr-auto">
											...
											<span class="text-white op-7">
                                                @php
                                                    $count_all= \App\Models\Invoice::count();
                                                    $count_invoices1 = \App\Models\Invoice::where('value_status', 3)
                                                    ->count();
